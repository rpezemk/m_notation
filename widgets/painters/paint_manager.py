...
def m_paint_visual(q_painter: QPainter, v_n: VisualNote, v_note_spacing: int, base_y_offset: int):
    el_painter.paint_visual_note(q_painter, v_n, v_note_spacing, base_y_offset)
