...
import os
from model.items_provider import ItemsProvider
import utils.file_utils.os_utils    
...
tree_provider = TreeProvider(utils.file_utils.os_utils.get_nice_dir_content)
